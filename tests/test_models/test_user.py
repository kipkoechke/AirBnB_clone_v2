...
class TestUserInstantiation(unittest.TestCase):
    ...
    def test_email_is_public_str(self):
        """Test that the 'email' attribute is a public string."""
        self.assertEqual(str, type(User.email))

    def test_password_is_public_str(self):
        """Test that the 'password' attribute is a public string."""
        self.assertEqual(str, type(User.password))

    def test_first_name_is_public_str(self):
        """Test that the 'first_name' attribute is a public string."""
        self.assertEqual(str, type(User.first_name))

    def test_last_name_is_public_str(self):
        """Test that the 'last_name' attribute is a public string."""
    ...
    def test_args_unused(self):
        """Test that passing arguments to User does not affect the instance."""
        user = User(None)
...
class TestUserSave(unittest.TestCase):
    ...
    def test_two_saves(self):
        """Test multiple saves to ensure 'updated_at' keeps updating."""
        user = User()
        sleep(0.05)
        first_updated_at = user.updated_at
        user.save()
    ...
    def test_save_with_arg(self):
        """Test the save method with an argument to ensure it raises an error."""
        user = User()
        with self.assertRaises(TypeError):
            user.save(None)

    def test_save_updates_file(self):
        """Test the save method to ensure it updates the 'file.json' file."""
        user = User()
        user.save()
...
class TestUserToDict(unittest.TestCase):
    ...
    def test_to_dict_type(self):
        """Test the type of the dictionary returned by the to_dict method."""
    ...
    def test_to_dict_output(self):
        """Test the output of the to_dict method with custom attributes."""
        dt = datetime.today()
        user = User()
        user.id = "123456"
        user.created_at = user.updated_at = dt
    ...
    def test_contrast_to_dict_dunder_dict(self):
        """Test that the output of to_dict differs from the __dict__ attribute."""
        user = User()
