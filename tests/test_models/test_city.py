...
class TestCityInstantiation(unittest.TestCase):
    ...
    def test_state_id_is_public_class_attribute(self):
        """Test that 'state_id' is a public class attribute in City class."""
        city = City()
    ...
    def test_name_is_public_class_attribute(self):
        """Test that 'name' is a public class attribute in City class."""
        city = City()
    ...
    def test_args_unused(self):
        """Test that passing arguments to City does not affect the instance."""
        city = City(None)
...
class TestCitySave(unittest.TestCase):
    ...
    def test_save_with_arg(self):
        """Test the save method with an argument, which should raise an error."""
        city = City()
        with self.assertRaises(TypeError):
            city.save(None)
...
class TestCityToDict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        """Test that to_dict includes additional attributes added to City."""
        city = City()
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        """Test that datetime attributes in the to_dict output are strings."""
        city = City()
    ...
    def test_to_dict_output(self):
        """Test the correctness of the to_dict output."""
        dt = datetime.today()
        city = City()
        city.id = "123456"
        city.created_at = city.updated_at = dt
